...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setApiError(err.response?.data?.message || "Reset password failed. Please try again.");
    } finally {
      setLoading(false);
    }
  };
          ...
          <div className="input-box">
            ...
            <div className="field-wrapper">
              <input
                ...
                value={password}
                onChange={(e) => { setPassword(e.target.value); if (errors.password) setErrors(prev => ({ ...prev, password: "" })); if (apiError) setApiError(""); }}
              />
          ...
          <div className="input-box">
            ...
            <div className="field-wrapper">
              <input
                ...
                onChange={(e) => { setConfirmPassword(e.target.value); if (errors.confirmPassword) setErrors(prev => ({ ...prev, confirmPassword: "" })); if (apiError) setApiError(""); }}
              />
